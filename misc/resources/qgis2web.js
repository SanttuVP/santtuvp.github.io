...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-10813426.774191, 1732343.080251, -10687190.837431, 1823675.534896], maxZoom: 21, minZoom: 1
    })
});


map.getView().fit([-10813426.774191, 1732343.080251, -10687190.837431, 1823675.534896], map.getSize());
